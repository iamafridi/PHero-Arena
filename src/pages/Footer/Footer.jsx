        ...
        <div>
            <footer className="bg-white">
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                    <div
                        className="flex flex-col items-center gap-4 rounded-lg bg-slate-400 p-6 shadow-lg sm:flex-row sm:justify-between"
                    >
                    ...
                    <div className="mt-16">
                        ...
                        <div className="mt-16 sm:flex sm:items-center sm:justify-between">
                            <div className="flex justify-center text-teal-600 sm:justify-start">
                                <button type="button">PHero-Arena <br />Created by Afridi</button>
                            </div>

                            <p className="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-right">
                                Copyright &copy; 2023. All rights reserved by Afridi Akbar Ifty.
                            </p>
                        </div>
                    </div>
                </div>
